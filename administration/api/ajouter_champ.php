...
$table = $_POST['table'];; // on stocke le type dan sune ariable
    ...
    $sql = 'Alter table '.$_POST[nom_table].' add '.replaceSpecialChar($_POST[nom_colonne]).' '.$_POST[data_type].' ';
...
echo json_encode(array('message' =>"Succés le champ a bien été créé")); 
}
else
